      ...
      <div className="md:w-[80%] w-[90%] m-auto md:flex h-full items-center">
        <div className="md:w-1/2">
          ...
          <button
            ...
            className="w-[140px] gap-2 font-semibold h-[40px] flex bg-white items-center justify-center rounded-md hover:bg-transparent hover:text-white hover:border-white hover:border"
          >
            Shop Now <MoveRight />
          </button>
        </div>
