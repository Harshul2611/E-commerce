...
const ProductDetailsCard = ({
  ...
  return (
    <div
      className="fixed flex items-center justify-center top-0 left-0 h-screen w-full z-50 bg-[#0000001d]"
          ...
          <div className="w-full md:w-1/2 md:pl-8 mt-6 md:mt-0">
            <div className="border-b relative pb-3 border-gray-200 flex items-center justify-between">
              <div className="flex items-start gap-3">
                <Image
                  src={
                    data?.Shop?.avatar ||
                    "https://ik.imagekit.io/harshulpatel/products/product-1762107110954_OST7YRSgg.jpg"
                  }
                  alt="Shop Logo"
                  width={60}
                  height={60}
              ...
              <button
                ...
                className="flex text-sm cursor-pointer items-center gap-2 px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md font-medium"
              >
                Chat with Seller
              </button>
            ...
            <div className="mt-5 flex items-center gap-5">
              <div className="flex items-center rounded-md">
                ...
                <span className="py-1 px-4 bg-gray-100">{quantity}</span>
                <button
