...
import { enhancements } from "@/utils/AI.enhanhcements";
...
const RichTextEditor = dynamic(
  () =>
    import("../../../../../../../packages/components/rich-text-editor").then(
      (mod) => mod.default
    ),
  { ssr: false }
);
...
const CreateProduct = () => {
  ...
  return (
    ...
    >
                  ...
                  {...register("sale_price", {
                    ...
                    validate: (value) => {
                      ...
                      if (regularPrice && value >= regularPrice) {
                        return "Sale price must be less then regular price";
                      }
                      return true;
                    },
                  })}
      ...
      {openImageModal && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-opacity-60 z-50 bg-black">
          <div className="bg-gray-800 p-6 rounded-lg w-[450px] text-white">
            ...
            <div className="relative w-full h-[250px] rounded-md overflow-hidden border border-gray-600">
              <Image layout="fill" src={selectedImage} alt="product-image" />
            </div>
            {selectedImage && (
