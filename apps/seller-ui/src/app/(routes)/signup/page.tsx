"use client";
import { sellerRegistration, verifySeller } from "@/lib/api/auth";
  ...
  const connectStripe = async () => {
    try {
      const response = await axiosInstance.post(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/create-stripe-link`,
        { sellerId }
      );
      ...
      console.log("Stripe Connecting error: ", error);
    }
  };
      ...
      <div className="md:w-[480px] p-8 bg-white shadow rounded-lg">
          ...
          <>
            {!showOtp ? (
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <label className="block text-gray-700 mb-1 mt-2">Pasword</label>
        ...
        {activeStep === 3 && (
          <div className="text-center">
            ...
            <br />
            <button
              className="w-full flex items-center justify-center m-auto gap-3 text-lg bg-[#334155] text-white py-2 rounded-lg"
